...
public class AddRoom extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == b1) {
            try {
                conn c = conn.getInstance();             // Singleton Pattern
                ...
                // ✅ Factory Pattern: create Roomm object
                Roomm newRoom = RoomFactory.createRoom(room, available, status, price, type);

                String str = "INSERT INTO room VALUES('" + newRoom.roomNumber + "', '" +
                        newRoom.availability + "', '" + newRoom.cleaningStatus + "', '" +
                        newRoom.price + "', '" + newRoom.bedType + "')";
